			   			...
			   			<ul className="slides">
				   			...
				   			<li>
				   				<div className="featured-post-slide">
						   			...
						   			<div className="post-background"  style={{ backgroundImage: "url('images/thumbs/featured/featured-1.jpg')"}}></div>
								   	...
								   	<div className="post-content">
								   		...
								   		<h1 className="slide-title"><a href="blog/single-standard" title="">Minimalism Never Goes Out of Style</a></h1> 
								   	</div> 				   					  
				   			...
				   			<li>
				   				<div className="featured-post-slide">
						   			...
						   			<div className="post-background" style={{backgroundImage: "url('images/thumbs/featured/featured-2.jpg')"}}></div>
								   	...
								   	<div className="post-content">
								   		...
								   		<h1 className="slide-title"><a href="blog/single-standard" title="">Enhancing Your Designs with Negative Space</a></h1>
						   			</div>		   				   					  
				   			...
				   			<li>
				   				<div className="featured-post-slide">
						   			...
						   			<div className="post-background" style={{backgroundImage:"url('images/thumbs/featured/featured-3.jpg');"}}></div>
								   	...
								   	<div className="post-content">
								   		...
								   		<h1 className="slide-title"><a href="blog/single-standard" title="">Music Album Cover Designs for Inspiration</a></h1>
						   			</div>
         	...
         	<article className="brick entry format-standard animate-this">
               ...
               <div className="entry-text">
               	<div className="entry-header">
               		...
               		<h1 className="entry-title"><a href="blog/single-standard">Just a Standard Format Post.</a></h1>
            ...
            <article className="brick entry format-standard animate-this">
               ...
               <div className="entry-text">
               	<div className="entry-header">
               		...
               		<h1 className="entry-title"><a href="blog/single-standard">This Is Another Standard Format Post.</a></h1>
            ...
            <article className="brick entry format-audio animate-this">
               ...
               <div className="entry-text">
               	<div className="entry-header">
               		...
               		<h1 className="entry-title"><a href="blog/single-audio">This Is a Audio Format Post.</a></h1>
         	...
         	<article className="brick entry animate-this">
               ...
               <div className="entry-text">
               	<div className="entry-header">
               		...
               		<h1 className="entry-title"><a href="blog/single-standard">Photography Skills Can Improve Your Graphic Design.</a></h1>
            ...
            <article className="brick entry animate-this" >
               ...
               <div className="entry-text">
               	<div className="entry-header">
               		...
               		<h1 className="entry-title"><a href="blog/single-standard">The 10 Golden Rules of Clean Simple Design.</a></h1>
               ...
               <div className="entry-text">
               	<div className="entry-header">
               		...
               		<h1 className="entry-title"><a href="blog/single-gallery">Workspace Design Trends and Ideas.</a></h1>
         	...
         	<article className="brick entry animate-this">
               ...
               <div className="entry-text">
               	<div className="entry-header">
               		...
               		<h1 className="entry-title"><a href="blog/single-standard">You Can See Patterns Everywhere.</a></h1>
               ...
               <div className="entry-text">
               	<div className="entry-header">
               		...
               		<h1 className="entry-title"><a href="blog/single-video">This Is a Video Post Format.</a></h1>
               ...
               <div className="entry-text">
               	<div className="entry-header">
               		...
               		<h1 className="entry-title"><a href="blog/single-standard">Breathtaking Photos of Lighthouses.</a></h1>
               ...
               <div className="entry-text">
               	<div className="entry-header">
               		...
               		<h1 className="entry-title"><a href="blog/single-standard">Designing With Black and White.</a></h1>
